...
public:
    StockfishWrapper(const std::string &path) : m_path(path) {
        std::cout << "Starting Stockfish process at: " << path << std::endl;
        ...
        std::cout << "Sending UCI command..." << std::endl;
