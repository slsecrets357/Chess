...
Game::Game(): selectedPiece(nullptr), stockfish("C:\\Users\\simon\\Documents\\Chess\\external\\Stockfish\\build\\bin\\stockfish.exe")
{
    board.initialize();
...
std::string Game::boardToFEN() {
    // Implement the method to convert the current board state to FEN
    // This is a placeholder example, adjust it according to your board implementation
    std::string fen = "your_board_fen_representation";
    return fen;
}
